...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pipeline.anim_speed'
        db.add_column('cursivedata_pipeline', 'anim_speed',
                      self.gf('django.db.models.fields.IntegerField')(default=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pipeline.anim_speed'
        db.delete_column('cursivedata_pipeline', 'anim_speed')
