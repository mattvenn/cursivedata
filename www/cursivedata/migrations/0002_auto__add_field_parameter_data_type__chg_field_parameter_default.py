...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parameter.data_type'
        db.add_column('cursivedata_parameter', 'data_type',
                      self.gf('django.db.models.fields.CharField')(default='float', max_length=20),
                      keep_default=False)


        # Changing field 'Parameter.default'
        db.alter_column('cursivedata_parameter', 'default', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Parameter.data_type'
        db.delete_column('cursivedata_parameter', 'data_type')


        # Changing field 'Parameter.default'
        db.alter_column('cursivedata_parameter', 'default', self.gf('django.db.models.fields.FloatField')())
