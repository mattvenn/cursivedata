...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pipeline.anim_autoplay'
        db.add_column('cursivedata_pipeline', 'anim_autoplay',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pipeline.anim_autoplay'
        db.delete_column('cursivedata_pipeline', 'anim_autoplay')
    ...
    models = {
        ...
        'cursivedata.endpoint': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 23, 0, 0)'}),
        ...
        'cursivedata.generator': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 23, 0, 0)'}),
            'last_used': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 23, 0, 0)'}),
