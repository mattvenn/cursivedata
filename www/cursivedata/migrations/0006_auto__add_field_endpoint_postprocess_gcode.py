...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Endpoint.postprocess_gcode'
        db.add_column('cursivedata_endpoint', 'postprocess_gcode',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Endpoint.postprocess_gcode'
        db.delete_column('cursivedata_endpoint', 'postprocess_gcode')
    ...
    models = {
        ...
        'cursivedata.endpoint': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)'}),
            ...
            'postprocess_gcode': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'cursivedata.generator': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)'}),
            'last_used': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)'}),
